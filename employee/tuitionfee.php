            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="formSubmenu">
                        ...
                        <li class="active"><a href="tuitionfee.php">คำร้องสวัสดิการเกี่ยวกับค่าเล่าเรียนบุตร</a></li>
                            ...
                            <form name="form6" action="insert6.php" method="post" target="iframe_target" >
                                ...
                                <div class="media" style="padding-bottom: 20px;padding-left: 40px;padding-right: 40px;padding-top: 20px;">
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" name="typebenefit" id="typebenefit">
                                ...
                                <div class="media" style="padding-bottom: 20px;padding-left: 40px;padding-right: 40px;padding-top: 20px;">
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <td>
                                                <select  class = "text_tui" name="child" id="child">
                                                        <option value="โปรดเลือก">โปรดเลือก</option>
                                ...
                                <div class="media" style="padding-bottom: 20px;padding-left: 40px;padding-right: 40px;padding-top: 20px;">
                                    ...
                                    <table >
                                        ...
                                        <tr>  
                                            ...
                                            <td>
                                                <select class="form-control" name="arrange" id="arrange">
                                                    <option value="โปรดเลือก">โปรดเลือก</option>
