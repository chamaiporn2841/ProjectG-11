...
<div class="sidenav">
    ...
    <a href="templatehr.php"><i class="fa fa-circle-o fa-fw" style="font-size: 12px;"></i>&ensp;เกณฑ์การใช้สวัสดิการ</a>
    ...
    <div class="top-container" style="z-index:4">
        ...
        <div class="dropdown">
            <table class="user-table">
                <tr class="user-tr">
                    <td class="user-td"><img class="user" src="images/user.jpg"/></td>
