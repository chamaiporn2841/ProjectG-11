            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="WelSubmenu">
                        <li class="active"><a href="definewel.php">เกณฑ์การใช้สวัสดิการ</a></li>
          ...
          <news>
            <div class="container-fluid" id="news">
              <div class="row">
                ...
                <form name="form8" action="inserthr.php" method="post"  target="iframe_target">
                            ...
                            <div class="media" style="padding-bottom: 20px;padding-left: 40px;padding-right: 40px;padding-top: 20px;" >
                                    ...
                                    <table >
                                        ...
                                        <tr>
                                            <th>รายละเอียดสวัสดิการ</th>
                                        </tr>
                                        <tr>
                                            <td>
                                                <textarea class="form-control" name="requirement_text" id="input" style="width:80%;height: 300px;" ></textarea>
                                            </td>
                                        </tr>        
                                        </tbody>
                                    </table>
