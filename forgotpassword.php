				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="mu-title" style="margin-top: -30px;">
							<b style="font-size: 20px;color:#0072b5;">ลืมรหัสผ่าน</b>
						</div>
                            <br/>
						<form action="check_forgot.php" method="post" style="color: #000;">
							<div class="form-group">
								<label for="password" style="font-size: 16px;font-weight: bold;">โปรดกรอกรหัสพนักงาน</label>
								<input type="textbox" class="form-control" name="emp_id" id="emp_id">
							</div>
							<div class="form-group">
								<label for="confirm_password"
									style="font-size: 16px;font-weight: bold;">โปรดกรอกอีเมล</label>
		...
		<div class="mu-footer-bottom">
			<div class="container">
				...
				<div class="mu-footer-bottom-area">
					...
					<p class="mu-copy-right" style="font-size: 14px; 14px;">&copy; Copyright 2563.
